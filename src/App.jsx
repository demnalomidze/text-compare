...
function Home({ setDataList }) {
  ...
  return (
    <div className="wallpaper">
      <div className="wl-leftside">
        <img className="image" src="/images/Bu.png" alt="main-logo" />
        <p className="wl-text"> ENAGRAM </p>
      </div>
      <div className="menu" onClick={() => handleData()}>
    ...
    <div className="main">
      <div className="main-box">
        ...
        >
          ...
          />
          <path
            d="M5.27596 2.66675L2.68396 8.67608"
            stroke="#132450"
            stroke-width="1.2"
            stroke-linecap="round"
            stroke-linejoin="round"
          />
          <path
            d="M7.85933 8.67608L5.276 2.66675"
            stroke="#132450"
            stroke-width="1.2"
            stroke-linecap="round"
            stroke-linejoin="round"
          ...
          />
          <path
            d="M12.7993 5.56598C13.5113 6.27798 13.5113 7.43198 12.7993 8.14332C12.0873 8.85532 10.9333 8.85532 10.222 8.14332C9.50999 7.43132 9.50999 6.27732 10.222 5.56598C10.9333 4.85398 12.088 4.85398 12.7993 5.56598"
            stroke="#132450"
            stroke-width="1.2"
            stroke-linecap="round"
            stroke-linejoin="round"
        ...
        <div className="main-text">
          <p className="main-box-text"> ტექსტის შედარება </p>
          <svg
            className="sec-svg"
            width="7"
            height="5"
      ...
      <div className="label-alpha-box">
        ...
        <div className="label-box">
          <label className="labell">
            <input className="for-label" type="checkbox" />
            <p className="checkbox-text"> ფორმატის შენარჩუნება </p>
          </label>
        </div>
      </div>
      <div className="changer-button">
        <button
          className="button-changer"
          onClick={() => {
            setIsClicked(!isClicked);
            handleReset();
          }}
          style={{
            backgroundColor: isClicked ? "#4571E4" : "#383a4899",
          }}
        >
          <svg
          ...
          <p className="changer-button-text"> ახლის გახსნა </p>
        </button>
      </div>
    </div>
  );
    ...
    <div className="footer">
      ...
      <div className="footer-inputs">
        ...
        >
          ...
          />
          <path
            d="M10.6654 10.6666L16.0001 5.33325L21.3347 10.6666"
            stroke="#323232"
            strokeWidth="2"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
          <path
            d="M21.3347 21.3307L16.0001 26.6654L10.6654 21.3307"
            stroke="#323232"
            strokeWidth="2"
            strokeLinecap="round"
            strokeLinejoin="round"
...
function FooterLast({ setCompare, setIsLoading, firstText, secondText }) {
  const isDisabled = firstText.trim() === "" || secondText.trim() === "";
    ...
    <div className="Head">
      <div className="hide-arrow">
        ...
        >
          ...
          />
          <path
            d="M15 14.1666L10.8333 9.99992L15 5.83325"
            stroke="white"
            stroke-opacity="0.5"
            stroke-linecap="round"
            stroke-linejoin="round"
      ...
      <div className="menu-list">
        ...
        <button className="menu-list-button">
          ...
          >
            <path
              d="M4.99708 21.0038H19.0029C20.1079 21.0038 21.0037 20.108 21.0037 19.003V4.99717C21.0037 3.89214 20.1079 2.99634 19.0029 2.99634H8.99875C7.89372 2.99634 6.99791 3.89214 6.99791 4.99717V19.003C6.99791 20.108 6.10211 21.0038 4.99708 21.0038V21.0038C3.89205 21.0038 2.99625 20.108 2.99625 19.003V7.99842C2.99625 6.89339 3.89205 5.99759 4.99708 5.99759H6.99791"
              stroke="white"
              stroke-width="1.5"
              stroke-linecap="round"
              stroke-linejoin="round"
      ...
      <div className="bottom-div">
        <div className="bottom-div-left">
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <g clip-path="url(#clip0_6209_217)">
            ...
            <defs>
              <clipPath id="clip0_6209_217">
                <rect width="20" height="20" fill="white" />
              </clipPath>
            </defs>
          </svg>
          <p className="bottom-div-text"> თამარ ონიანი </p>
        </div>
        <div className="bottom-div-right">
          ...
          >
            <path
              d="M18.5027 12C18.5027 12.2762 18.2788 12.5002 18.0025 12.5002C17.7262 12.5002 17.5023 12.2762 17.5023 12C17.5023 11.7237 17.7262 11.4998 18.0025 11.4998C18.2788 11.4998 18.5027 11.7237 18.5027 12"
              stroke="white"
              stroke-width="1.5"
              stroke-linecap="round"
              stroke-linejoin="round"
            />
            <path
              d="M12.5002 12C12.5002 12.2762 12.2763 12.5002 12 12.5002C11.7237 12.5002 11.4998 12.2762 11.4998 12C11.4998 11.7237 11.7237 11.4998 12 11.4998C12.2763 11.4998 12.5002 11.7237 12.5002 12"
              stroke="white"
              stroke-width="1.5"
              stroke-linecap="round"
              stroke-linejoin="round"
            />
            <path
              d="M6.4977 12C6.4977 12.2762 6.27375 12.5002 5.99749 12.5002C5.72123 12.5002 5.49728 12.2762 5.49728 12C5.49728 11.7237 5.72123 11.4998 5.99749 11.4998C6.27375 11.4998 6.4977 11.7237 6.4977 12"
              stroke="white"
              stroke-width="1.5"
              stroke-linecap="round"
              stroke-linejoin="round"
  ...
  return (
    <div className="menudata">
      <div className="menudata-box">
        <div className="menudata-arrow" onClick={() => setDataList(false)}>
          <svg
            className="sixth-svg"
            width="20"
            height="20"
        ...
        <div className="menudata-bottom-div">
          <div className="menudata-bottom-div-left">
            <svg
              className="ninth-svg"
              width="20"
              height="20"
            ...
            <p className="menudata-bottom-div-text"> თამარ ონიანი </p>
          </div>
          <div className="menudata-bottom-div-right">
            <svg
              className="tenth-svg"
              width="24"
              height="24"
